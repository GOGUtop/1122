    ...
    final class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
        ...
        init(browser: BrowserModel) {
            ...
            browser.liveBridge.onEvent = { [weak browser] event in
                ...
                case "end":
                    let resolvedId = browser.currentGenerationId ?? id
        ...
        func userContentController(
            ...
            Task { @MainActor in
                ...
                if type == "started" {
                    ...
                    let resolvedId = browser.currentGenerationId ?? fallbackGenerationId ?? id
                    browser.isGenerating = false
                    ...
                    Task { @MainActor in
                        ...
                        if stillGenerating {
                            ...
                            if self.completionStableTicks >= 3 {
                                ...
                                let id = self.browser.currentGenerationId
                                    ?? self.fallbackGenerationId
                                    ?? "poll-\(UUID().uuidString)"
